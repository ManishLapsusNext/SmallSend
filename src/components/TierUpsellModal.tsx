    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-lg bg-[#12141c] border border-white/10 rounded-[32px] overflow-hidden shadow-2xl"
        >
          ...
          <div className="p-8 pt-4 text-center">
            ...
            <div className="space-y-4 mb-10 text-left bg-white/5 rounded-2xl p-6 border border-white/5">
              <div className="flex items-center gap-3 text-slate-300">
                ...
                <span className="text-sm font-semibold">
                  Interactive Mode (High-Quality Images)
                </span>
              </div>
              <div className="flex items-center gap-3 text-slate-300">
                <div className="w-5 h-5 bg-deckly-primary/20 rounded-full flex items-center justify-center text-deckly-primary text-[10px]">
            ...
            <div className="flex flex-col gap-3">
              <Button
                size="lg"
                className="w-full bg-deckly-primary hover:bg-deckly-primary/90 text-white font-black py-6 rounded-2xl text-lg shadow-[0_8px_32px_-8px_rgba(0,18,255,0.5)] group"
                onClick={() => {
